...
# 今後について
<br>
W65C816の魅力であるネイティブモードで動作するソフトウェアが少ないので、<br>
それについて、少し深くハマってみようかと。<br>
また、今はスタンドアロンのソフトが３つのみで、切り替えにリセットが必要です。<br>
また、ネイティブモードとエミュレーションモードがもっと簡単に切り替えられる<br>
ようになれば、楽しいかなと思ってます。<br>
<br>
<br>
