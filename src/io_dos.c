...
//   req_tbl.CREQ_COM, req_tbl.disk_drive, req_tbl.disk_track, req_tbl.disk_sector, req_tbl.data_adr);
//debug
...
//debug
//printf("UREQ_COM(%02x), UNI_CHR(%02x)\r\n", req_tbl.UREQ_COM, req_tbl.UNI_CHR);
//debug
